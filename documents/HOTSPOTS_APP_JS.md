...
- Global profile editor auto-targeting wrong schedule when no group is actively open.
...
- Confirm global profile editor (above Unmonitored) can create/rename/delete/edit and auto-target the open group (fallback: first monitored group).
